* Plan
This is an outline of a plan for a podcast-like experimental media system for presentation and interaction.

We want to : 

create creative commons licensed content and using self-hosted 
open source software that supports experiments in automation and code for each episode.

support online collaboration, webinars, conferences, 
video streaming, production of video and audio content in an interactive manner.
...
***** Provoke Imagination
****** Sozi
Like sozi or prezzi is based on a static image, we can play on top of multiple animated images or video clips.
...
The text should accessible to blind users.
...
3. Each head or character goes to a profile page, those profiles are organized in an org chart.
...
** Diction
Effective Choice and Usage of words. 
